...
import 'package:bold_beauty_lounge/components/searchbar.dart' as custom_search;
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Icon(Icons.discount, size: 28, color: Colors.black),
                      SizedBox(height: 10),
...
class HorizontalText extends StatelessWidget {
  const HorizontalText({super.key});
...
class CategoryCard extends StatelessWidget {
  ...
  const CategoryCard({super.key, required this.e});
