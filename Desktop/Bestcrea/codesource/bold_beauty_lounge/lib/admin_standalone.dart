...
void main() async {
  ...
  try {
    // Initialize Firebase - only Core, Auth, and Firestore (no Storage)
  ...
  runApp(const AdminStandaloneApp());
}

class AdminStandaloneApp extends StatelessWidget {
  const AdminStandaloneApp({super.key});
