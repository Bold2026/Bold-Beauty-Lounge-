...
class _OfflineHomeScreenState extends State<OfflineHomeScreen> {
                        ...
                        child: Image.asset(
                          ...
                          errorBuilder: (context, error, stackTrace) {
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                color:
                                    const Color(0xFFE9D7C2).withOpacity(0.12),
                                borderRadius: BorderRadius.circular(16),
                              ),
                              child: Icon(
    ...
    return Row(
      children: [
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Rechercher un soin ou une experte...',
                hintStyle: TextStyle(
                  color: Colors.black.withValues(alpha: 0.35),
                ),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              colors: [Color(0xFFE9D7C2), Color(0xFFE8D7BB)],
              begin: Alignment.topLeft,
              end: Alignment.bottomRight,
            ),
            borderRadius: BorderRadius.circular(26),
            boxShadow: [
              BoxShadow(
                color: const Color(0xFFE9D7C2).withValues(alpha: 0.4),
                blurRadius: 18,
                offset: const Offset(0, 8),
              ),
            ],
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildCategoryCard(context, service);
              },
            ),
          ),
        ],
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Découvrez nos rituels d’exception prêts à réserver.',
              style: TextStyle(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return AnimatedBuilder(
                  animation: _packPageController,
                  builder: (context, child) {
                    double value = 1.0;
                    if (_packPageController.hasClients &&
                        _packPageController.position.haveDimensions) {
                      value = (1 -
                              ((_packPageController.page ??
                                              _packPageController.initialPage) -
                                          index)
                                      .abs() *
                                  0.12)
                          .clamp(0.88, 1.0);
                  ...
                  child: _buildPackCard(context, pack),
                );
              },
            ),
          ),
          const SizedBox(height: 14),
          _buildPageIndicator(_packPageController, _comboPacks.length),
        ],
      ),
    );
  }
  ...
  Widget _buildPackCard(BuildContext context, Map<String, dynamic> pack) {
    final List<String> details =
        (pack['details'] as List<dynamic>).cast<String>();
  ...
  void _openCategory(BuildContext context, String category) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => DetailedPricingScreen(initialCategory: category),
      ),
    );
  }
    ...
    final actions = [
      {
        ...
        'onTap': () => Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const OfflineBookingScreen()),
            ),
      },
      {
        'title': 'Nos Tarifs',
      ...
      },
      {
        ...
        'onTap': () => Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const BoldBeautyDetailPage()),
            ),
      },
    ];
